<template>
  <div class="hello">
    ...
    <button :disabled="loading" v-on:click="getSpecificDocument(), loading=true">Procurar despesa pública</button>
    <p></p>
    <body>
  ...
  methods: {
    ...
    editComment: function (commentId, author, comment, prevComment) {
      ...
      axios.put(process.env.VUE_APP_API + this.codigo + '/comments/' + commentId, {author: author, comment: comment}).then((response) => {
        const editIndex = this.comments.findIndex((element) => {
    ...
    deleteComment: function (commentId) {
      axios.delete(process.env.VUE_APP_API + this.codigo + '/comments/' + commentId).then((response) => {
        ...
        const deleteIndex = aux.findIndex((element) => {
